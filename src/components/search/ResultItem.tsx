export default function ResultItem({ item }: any) {
  return (
    <div className="bg-white/80 h-[140px] backdrop-blur border border-gray-200 p-4 rounded-2xl shadow-sm space-y-4 hover:bg-gray-100 hover:shadow-lg transition hover:cursor-pointer dark:bg-gray-800/70 dark:border-gray-700">
